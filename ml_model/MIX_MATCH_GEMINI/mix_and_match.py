...
def mix_and_match(img):
    ...
    t-shirt, button up shirt, blouse, tank top, jackets and coats, jeans, pants, shorts, dress, skirt, polo shirt\
    tops are: t-shirt, button up shirt, blouse, tank top, jackets and coats, polo shirt, dress\
    bottoms are: jeans, pants, shorts, skirt\
